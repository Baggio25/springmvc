...
import com.algaworks.brewer.service.exception.EmailUsuarioJaCadastrado;
...
public class UsuariosController {
	...
	public ModelAndView salvar(@Valid Usuario usuario, BindingResult result, RedirectAttributes attributes) {
		...
		try {
			...
			return novo(usuario);
		} catch (SenhaObrigatoriaUsuarioExpcetion e) {
	...
	public ModelAndView pesquisar(UsuarioFilter usuarioFilter, 
		...
		PageWrapper<Usuario> paginaWrapper = new PageWrapper<Usuario>(usuarios.filtrar(usuarioFilter, pageable), 
				httpServletRequest);
