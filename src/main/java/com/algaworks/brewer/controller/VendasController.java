...
public class VendasController {
	...
	@Autowired
	private CadastroVendaService cadastroVendasService;
	...
	public ModelAndView pesquisar(VendaFilter vendaFilter, @PageableDefault(size = 10) Pageable pageable, 
		...
		PageWrapper<Venda> paginaWrapper = new PageWrapper<Venda>(vendas.filtrar(vendaFilter, pageable), httpServletRequest);
	...
	public ModelAndView salvar( Venda venda, BindingResult result, RedirectAttributes attributes, @AuthenticationPrincipal UsuarioSistema usuarioSistema) {
		...
		cadastroVendasService.salvar(venda);
	...
	public ModelAndView emitir( Venda venda, BindingResult result, RedirectAttributes attributes, @AuthenticationPrincipal UsuarioSistema usuarioSistema) {
		...
		cadastroVendasService.emitir(venda);
	...
	public ModelAndView cancelar( Venda venda, BindingResult result,
		...
		try {
			cadastroVendasService.cancelar(venda);
