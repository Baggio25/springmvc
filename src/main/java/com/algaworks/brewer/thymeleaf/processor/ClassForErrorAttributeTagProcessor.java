...
/**
 * Classe responsável por definir o processador de tags de erro das páginas
 * 
 * Ex.: brewer:classforerror="sku"
 * @author rodri
 *
 */
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor{
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
		...
		if(temErro) {
			...
			structureHandler.setAttribute("class", classesExistentes + " has-error"); //seta no class da tag a classe has error junto com as demais;
		}
	}
