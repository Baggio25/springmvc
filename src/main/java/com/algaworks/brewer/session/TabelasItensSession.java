...
public class TabelasItensSession {
	...
	private Set<TabelaItensVenda> tabelas = new HashSet<TabelaItensVenda>();

	public void adicionarItem(String uuid, Cerveja cerveja, int quantidade) {
		TabelaItensVenda tabela = buscarTabelaUuid(uuid);
	...
	public List<ItemVenda> getItens(String uuid) {
		return buscarTabelaUuid(uuid).getItens();
	}
	
	public Object getValorTotal(String uuid) {
		return buscarTabelaUuid(uuid).getValorTotal();
	}
	
	private TabelaItensVenda buscarTabelaUuid(String uuid) {
